...
export const metadata: Metadata = {
  title: "Bookmarked Questions | Dev Axioms",
  description: "Access your saved practice questions and continue practicing.",
};
    ...
    <div className="mx-auto max-w-5xl px-4 md:px-6 py-10 space-y-6 select-none">
      ...
      <div className="flex items-center justify-between border-b border-border/60 pb-5">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-1">
            {bookmarkedQuestions.length} {bookmarkedQuestions.length === 1 ? "question" : "questions"} saved for later
          </p>
        </div>
      ...
      {bookmarkedQuestions.length === 0 ? (
        <div className="rounded-xl border border-border/60 bg-card/30 py-16 text-center shadow-xs space-y-3">
          <p className="text-sm font-semibold text-foreground">No Bookmarked Questions Yet</p>
          <p className="text-xs text-muted-foreground max-w-sm mx-auto">
            Bookmark questions while practicing to save them for revision.
          </p>
