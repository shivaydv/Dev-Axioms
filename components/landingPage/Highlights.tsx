...
function Highlights(): React.ReactElement {
  return (
    <motion.div
      ...
      className="border-border bg-background grid grid-cols-1 border-r border-b md:grid-cols-2 lg:grid-cols-3"
    >
...
function Highlight({
  ...
  return (
    <motion.div
      ...
      className="border-border border-t border-l px-6 py-12"
    >
      <motion.div
        ...
        className="text-muted-foreground mb-4 flex flex-row items-center gap-2"
      >
        <motion.div
          initial={{ scale: 0 }}
          viewport={{ once: true }}
